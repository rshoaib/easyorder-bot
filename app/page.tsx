...
import { ArrowRight, CheckCircle2, ShoppingBag, Smartphone, Share2, MessageCircle, Sparkles, LayoutDashboard, Palette, Zap, UtensilsCrossed, Home, Cake, Store, Send } from "lucide-react";

const WHATSAPP_SHARE_URL = `https://wa.me/?text=${encodeURIComponent("Check out OrderViaChat — a free tool to create a digital menu and get orders on WhatsApp! 🚀\nhttps://orderviachat.com")}`;
  ...
  return (
    <main className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left space-y-6">
              ...
              <div className="animate-fade-in delay-300">
                ...
                >
                  <Send size={14} className="group-hover:text-green-500 transition-colors" />
                  Know a business owner? <span className="underline underline-offset-2 font-medium text-slate-500 group-hover:text-green-600">Share via WhatsApp</span>
                </a>
              </div>
            </div>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white w-14 h-14 rounded-full shadow-lg shadow-green-500/30 flex items-center justify-center hover:scale-110 active:scale-95 transition-all group"
