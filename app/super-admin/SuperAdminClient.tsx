...
import { LayoutDashboard, Store, Sparkles, CreditCard, Plus, Search } from 'lucide-react';
            ...
            <header className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-zinc-200">
                <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3 min-w-0">
                        <div className="w-7 h-7 rounded-md bg-zinc-900 text-white flex items-center justify-center text-xs font-bold">
                            OV
                        </div>
                        <span className="font-semibold text-sm text-zinc-900">Super Admin</span>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-1.5 h-9 px-3 rounded-lg bg-zinc-900 text-white text-sm font-medium hover:bg-zinc-800 transition"
                        >
                ...
                {/* Tab strip */}
                <nav className="max-w-7xl mx-auto px-6 flex items-center gap-1 -mb-px">
                    {TABS.map(({ key, label, icon: Icon }) => {
                        ...
                        return (
                            <button
                                key={key}
                                onClick={() => setTab(key)}
                                className={`inline-flex items-center gap-2 px-3 h-10 text-sm font-medium border-b-2 transition ${
                                    active
